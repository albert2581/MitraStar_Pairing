...
import com.example.kerorodoodesk.mtapp.HTTPService;
...
import com.google.android.exoplayer.demo.player.vMediaController;
...
public class PlayerActivity extends Activity implements SurfaceHolder.Callback, OnClickListener,
    ...
    private vMediaController vMediaController;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //startService(new Intent(PlayerActivity.this,HTTPService.class));
...
//        contentId = intent.getStringExtra(CONTENT_ID_EXTRA);
        contentType = PlayerActivity.TYPE_DASH;
        contentId = "10_20".toLowerCase(Locale.US).replaceAll("\\s", "");
        ...
        root.setOnKeyListener(new OnKeyListener() {
            ...
            public boolean onKey(View v, int keyCode, KeyEvent event) {
                if (keyCode == KeyEvent.KEYCODE_MEDIA_PLAY_PAUSE) {
                    return vMediaController.dispatchKeyEvent(event);
                }
                return false;
            }
        });
    ...
    mediaController.setAnchorView(root);*/
        vMediaController = new vMediaController(this, true);
        vMediaController.setAnchorView(root);
    ...
    public void preparePlayer() {
      ...
      mediaController.setEnabled(true);*/
            vMediaController.setMediaPlayer(player.getPlayerControl());

            vMediaController.setEnabled(true);
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event ) {
        if ((keyCode == KeyEvent.KEYCODE_BACK)) {
            ...
            intent.setClass(PlayerActivity.this, ListVideoActivity.class);
